...
function getNewsStats() {
    fetch('https://gnews.io/api/v3/search?q=sri&lanka&token=9335a76f3d9fc2c31ac210b3360a79b4')
...
button.addEventListener('click',function(){  
    fetch('https://gnews.io/api/v3/search?q=' + inputValue.value +'&token=9335a76f3d9fc2c31ac210b3360a79b4')
...
var str = "More Details!";
var result = str.link(urllValue);
document.getElementById("search1").innerHTML = result;
